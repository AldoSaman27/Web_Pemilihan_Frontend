...
const SideBar = ({ Active }) => {
  ...
  return (
    <div className="SideBar">
      ...
      <ul>
        <li
          className={`d-flex align-items-center gap-2 fw-semibold text-white ${
            Active === 1 ? "Active" : ""
          }`}
        ...
        <li
          ...
          onClick={() => Navigate("/admin/pasangan-calon")}
        >
          <PersonVcard size={25} />
          Pasangan Calon
        </li>
        ...
        <li
          className="d-flex align-items-center gap-2 fw-semibold text-danger LogOut"
