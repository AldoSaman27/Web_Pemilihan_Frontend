...
const Pemilih = () => {
  ...
  useEffect(() => {
    ...
    axios.defaults.headers.common["Accept"] = "application/json";
    axios
      .get(`${process.env.REACT_APP_API_URL}/api/v2/pemilih/index`)
      .then((ress) => {
  ...
  const HandleTambah = () => {
    ...
    axios.defaults.headers.common["Accept"] = "application/json";
    axios
      .post(`${process.env.REACT_APP_API_URL}/api/v2/pemilih/store`, formData)
      .then((ress) => {
  ...
  const HandleHapus = (item) => {
    Swal.fire({
      ...
      if (ress.isConfirmed) {
        ...
        axios
          .delete(
            `${process.env.REACT_APP_API_URL}/api/v2/pemilih/destroy/${item.id}`
          )
          .then((ress) => {
  ...
  const HandleEdit = (item) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_URL}/api/v2/pemilih/update/${item.id}`,
        formData
      )
      .then((ress) => {
      ...
      <div className="ContainerContent">
        ...
        <div className="Content">
          <div className="d-flex align-items-center justify-content-between pe-5 mb-3">
            ...
            <Button variant="primary" onClick={handleShowTambah}>
              Tambah Pemilih
            </Button>
          </div>
                ...
                <tr key={index}>
                  ...
                  <Modal show={showEdit} onHide={handleCloseEdit}>
                    ...
                    <Modal.Body>
                      ...
                      <FloatingLabel
                        controlId="floatingVotingCode"
                        label="VotingCode"
                        className="mt-2"
                      >
                        <Form.Control
                          type="text"
                          placeholder="VotingCode"
                          defaultValue={item.uniqcode}
                          disabled
                        />
                      </FloatingLabel>
                    </Modal.Body>
